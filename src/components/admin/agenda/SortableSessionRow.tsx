...
import { GripVertical, Pencil, Copy, Star, Users, Trash2, Archive } from 'lucide-react';
...
export function SortableSessionRow({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="flex items-center gap-2 rounded-lg border border-border bg-card p-3 hover:bg-muted/50 transition-colors cursor-pointer animate-fade-in"
      onClick={onClick}
    >
      <Tooltip>
